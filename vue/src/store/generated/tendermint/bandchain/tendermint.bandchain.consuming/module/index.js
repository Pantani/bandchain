...
const txClient = async (wallet, { addr: addr } = { addr: "http://localhost:26657" }) => {
    ...
    return {
        ...
        msgSendCreatePair: (data) => ({ typeUrl: "/tendermint.bandchain.consuming.MsgSendCreatePair", value: data }),
        msgSendSellOrder: (data) => ({ typeUrl: "/tendermint.bandchain.consuming.MsgSendSellOrder", value: data }),
        msgOracleData: (data) => ({ typeUrl: "/tendermint.bandchain.consuming.MsgOracleData", value: data }),
    };
};
