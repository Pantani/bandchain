...
export type ConsumingMsgOracleDataResponse = object;

export type ConsumingMsgSendCreatePairResponse = object;

export type ConsumingMsgSendSellOrderResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryBuyOrderBookAll = (
    ...
    this.request<ConsumingQueryAllBuyOrderBookResponse, RpcStatus>({
      path: `/tendermint/bandchain/consuming/buyOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  queryBuyOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<ConsumingQueryGetBuyOrderBookResponse, RpcStatus>({
      path: `/tendermint/bandchain/consuming/buyOrderBook/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  querySellOrderBookAll = (
    ...
    this.request<ConsumingQueryAllSellOrderBookResponse, RpcStatus>({
      path: `/tendermint/bandchain/consuming/sellOrderBook`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
  ...
  querySellOrderBook = (index: string, params: RequestParams = {}) =>
    this.request<ConsumingQueryGetSellOrderBookResponse, RpcStatus>({
      path: `/tendermint/bandchain/consuming/sellOrderBook/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   */
  queryLastOracleId = (params: RequestParams = {}) =>
    this.request<ConsumingQueryLastOracleIdResponse, RpcStatus>({
      path: `/tendermint/consuming/last_request_id`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   */
  queryOracleResult = (requestId: string, params: RequestParams = {}) =>
    this.request<ConsumingQueryOracleResponse, RpcStatus>({
      path: `/tendermint/consuming/result/${requestId}`,
      method: "GET",
      format: "json",
      ...params,
    });
